...
<div className={sidebarOpen ? 'translate-x-0 ease-out fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0' : '-translate-x-full ease-in'}></div>
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            <header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
                <div class="flex items-center">
                    <button onClick={() =>setSidebarOpen(!sidebarOpen)}  class="text-gray-500 focus:outline-none lg:hidden">
                ...
                <div class="flex items-center">
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        ...
                        <div x-show="dropdownOpen" onClick={() =>setDropdownOpen(!dropdownOpen)} class="fixed inset-0 z-10 w-full h-full"
