    ...
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Biologiya</div>
      ...
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Ingliz tili</div>
      ...
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Tarix</div>
      ...
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Javoblar</div>
