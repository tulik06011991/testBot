              ...
              <Link to={'/biologiya'}>
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                  ...
                  <div class="flex flex-col flex-grow ml-4">
                    <div class="text-sm text-gray-500 font-bold">Biologiya</div>
            ...
            <div class="col-span-12 sm:col-span-6 md:col-span-3">
              <Link to={'/inglizTili'}>
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                  ...
                  <div class="flex flex-col flex-grow ml-4">
                    <div class="text-sm text-gray-500 font-bold">Ingliz tili</div>
            ...
            <div class="col-span-12 sm:col-span-6 md:col-span-3">
              <Link to={'/tarix'}>
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                  ...
                  <div class="flex flex-col flex-grow ml-4">
                    <div class="text-sm text-gray-500 font-bold">Tarix</div>
            ...
            <div class="col-span-12 sm:col-span-6 md:col-span-3">
              <Link to={'/javob'}>
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                  ...
                  <div class="text-sm text-gray-500 font-bold">Javob</div>
                  <div class="flex flex-col flex-grow ml-4">
